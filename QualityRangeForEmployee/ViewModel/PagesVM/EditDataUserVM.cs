...
namespace QualityRangeForEmployee.ViewModel.PagesVM
{
    internal class EditDataUserVM : ViewModel.Base.ViewModel
    {
        ...
        #region Property
        private Employee _editingEmployee = DataBase.ConnectionDataBase.employee;
        public Employee EditingEmployee { get => _editingEmployee; set => Set(ref _editingEmployee, value); }
        #endregion
        ...
        private void OnChangeImageExecute(object parameter)
        {
            ...
            _editingEmployee.ProfilePhoto = imageFromExplorer;
        ...
        {
            (List<string> messages, bool isValid) = ValidatePassword(_editingEmployee.User.Password);
            if (isValid == false)
            {
                new MessageBox().Show();
            ...
            if (String.IsNullOrEmpty(_editingEmployee.Name) || String.IsNullOrEmpty(_editingEmployee.Surname) || String.IsNullOrEmpty(_editingEmployee.Patronymic))
            {
                new MessageBox().Show();
